...
/**
 * JPA-сущность модуля управления LC.
 *
 * <p>Общие параметры модуля наследуются от {@link ModuleEntity}.</p>
 */
@Entity
@Table(name = "lc")
public class LCEntity extends ModuleEntity {
